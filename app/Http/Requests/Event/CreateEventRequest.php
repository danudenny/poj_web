...
class CreateEventRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'latitude' => ['required', Rule::requiredIf($this->input('location_type') == Event::LocationTypeExternal)],
            'longitude' => ['required', Rule::requiredIf($this->input('location_type') == Event::LocationTypeExternal)],
            'location_type' => ['required', Rule::in(Event::LocationTypeInternal, Event::LocationTypeExternal)],
            'address' => ['required'],
            'date_event' => ['required', 'date'],
            'time_event' => ['required', 'date_format:H:i:s'],
