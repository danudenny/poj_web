...
class CreateEventRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'latitude' => [Rule::requiredIf($this->input('location_type') == Event::LocationTypeExternal)],
            'longitude' => [Rule::requiredIf($this->input('location_type') == Event::LocationTypeExternal)],
