...
Route::post('admin/face-initial/change', [UserController::class, 'changeUserInitialFaceURL']);
...
//    });
    ...
    Route::group(['prefix' => 'attendance'], function() {
        ...
        Route::get('export-list-attendance', [EmployeeAttendanceController::class, 'downloadEmployeeAttendance']);
    });
    ...
    Route::group(['prefix' => 'timesheet-report'], function () {
        ...
        Route::get('employee-auto-report', [TimesheetReportController::class, 'employeeAutoReport']);
