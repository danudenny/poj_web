    ...
    methods: {
        initializeEmployeesTable() {
            ...
            this.table = new Tabulator(this.$refs.employeesTable, {
                ...
                ajaxURL: `/api/v1/admin/employee?kanwil_id=${this.id}`,
                ajaxConfig: {
                    headers: {
                ...
                ajaxURLGenerator: (url, config, params) => {
                    ...
                    return `${url}&page=${params.page}&size=${params.size}&name=${this.filterName}&email=${this.filterEmail}&area=${this.filterArea}&cabang=${this.filterCabang}&outlet=${this.filterOutlet}&job=${this.filterJob}`
                },
                layout: 'fitDataFill',
                renderHorizontal:"virtual",
                progressiveLoad: 'scroll',
                height: '100%',
                groupBy: ['area.name', 'cabang.name', 'outlet.name'],
