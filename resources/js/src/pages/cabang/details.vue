            ...
            <div class="card">
                <div className="card-header bg-primary">
                    <div class="d-flex justify-content-between">
                        <h5>{{item.name}}</h5>
                        <button class="btn btn-sm btn-outline-warning" @click="$router.push('/cabang')">
...
import AssignWorkReporting from "@/pages/cabang/modal/assignWorkReporting.vue";
...
export default {
    ...
    methods: {
        ...
        getUnit() {
            axios
                .get(`/api/v1/admin/unit/view/${this.$route.params.id}?unit_level=6`)
                .then(response => {
