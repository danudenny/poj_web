    ...
    methods: {
        initializeEmployeesTable() {
            ...
            this.table = new Tabulator(this.$refs.employeesTable, {
                ...
                ajaxURL: `/api/v1/admin/employee?outlet_id=${this.id}`,
                ajaxConfig: {
                    headers: {
                ...
                ajaxURLGenerator: (url, config, params) => {
                    ...
                    return `${url}&page=${params.page}&size=${params.size}&name=${this.filterName}&email=${this.filterEmail}&outlet=${this.filterOutlet}&job=${this.filterJob}`
                },
                layout: 'fitDataFill',
